        ...
        <div className="md:col-span-2 grid sm:grid-cols-2 gap-5">
          <div>
            ...
            <li className="grid gap-2 list-none text-sm font-bold">
              <Link to="/my-stats/tracks">User's Top Tracks</Link>
              <Link to="/my-stats/artists">User's Top Artists</Link>
              <Link to="/my-stats/albums">User's Top Albums</Link>
              <Link to="/my-stats/genres">User's Top Genres</Link>
            </li>
          </div>
